...
Total time per bit = 0.1 + 0.2 + 0.125 = 0.425 ns/bit. Teff = 1 / 0.425 ns/bit ˜ 2.35 Gbps. Look familiar? It’s the harmonic mean of the bitrates—or, if you squint, it’s bandwidth behaving like conductance, the inverse of resistance. That’s right: *subsystems in series with full-block handoffs calculate like resistors in parallel.*
